...
- [x] 5. Update CreateNote RPC to generate and persist IDs
  - [x] 5.1 Modify `notes/create_note.go`
...
- [x] 6. Update GetNote RPC to resolve by ID
  - [x] 6.1 Modify `notes/get_note.go`
...
- [x] 7. Update UpdateNote RPC to resolve by ID
  - [x] 7.1 Modify `notes/update_note.go`
  ...
  - [x] 7.2 Write property test: update by ID preserves the Note_ID
...
- [x] 8. Update DeleteNote RPC to resolve by ID and clean up registry
  - [x] 8.1 Modify `notes/delete_note.go`
    - Validate the `id` field with `validateUuidV4`
...
- [x] 10. Update ListNotes RPC to include IDs
  - [x] 10.1 Modify `notes/list_notes.go`
  ...
  - [x] 10.2 Write property test: create then list includes the created note's ID
  ...
  - [x] 10.3 Write unit test: orphan note file returns empty ID
